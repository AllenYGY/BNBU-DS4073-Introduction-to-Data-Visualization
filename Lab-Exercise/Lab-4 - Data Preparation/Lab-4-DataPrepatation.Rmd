...
# write your answer here
newdata <- filter(starwars, species == "Human" & height>170)
print(newdata)
```
...
# Please read Salaries data from the file Salaries.txt
# write your answer here
data = read_tsv("Salaries.txt")
print(data)
# Select the female professors whose salaries are between 80000 and 100000
# write your answer here
newdata <- filter(data, sex == "Female", salary >= 80000, salary <= 100000)
