...
ggplot(Salaries, 
  ...
  labs(title = "Academic salary by rank, years since PhD, and years of service")
```
...
# plot(2, 1) – Sepal.Width vs Sepal.Length
...
# Why groupColumn = 5?
# because the 5th column (Species) is the categorical variable used to color the lines by species group.
```
...
# Plot with setosa highlighted
ggparcoord(data,
           columns = 1:4, 
           groupColumn = 5, 
           order = "anyClass",
           showPoints = TRUE, 
           title = "Highlighting Setosa",
           alphaLines = 1) + 
  scale_color_manual(values = c(
    "setosa"     = "#69b3a2",  # highlighted group
    "versicolor" = "#E8E8E8",
    "virginica"  = "#E8E8E8"
  )) +
  theme(legend.position = "top",
