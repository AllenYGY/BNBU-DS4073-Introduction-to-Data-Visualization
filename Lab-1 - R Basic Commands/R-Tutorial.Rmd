...
Download provided *.rmd* and *style.css* files from ispace, put them in the same folder, and load *.rmd* in RStudio.
...
Specifically, we first make sure the current path in the **Terminal** window is the path of test.R. Then type in the following command prompt in the **Terminal** window.
